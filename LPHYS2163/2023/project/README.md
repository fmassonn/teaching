...
Here is a 5-minute video that shows the evolution, hour by hour for the
...
[![Watch the
video](https://i9.ytimg.com/vi_webp/J1ckvu8Go58/mq2.webp?sqp=CNSfw6oG-
oaymwEmCMACELQB8quKqQMa8AEB-AG-B4AC0AWKAgwIABABGHIgNig2MA8=&rs=
AOn4CLAgv1y4OaFIiIh_XlJvRbYh75sVCQ)](https://www.youtube.com/watch?v=
J1ckvu8Go58)
...
- Where on Earth is the geopotential highest or lowest, and why? - Do
you see a seasonal dependence in the four fields?

Next, you are asked to focus on the four following periods:
...
air temperature? Do you perhaps remember yourselves these situations?
...
coding is Python but alternatives are of course acccepted.

Your objective is to plot a map of the geopotential (in m$^2$/s$^2$) of
...
## Step 3. Calculating and plotting a gradient in spherical
## coordinates
